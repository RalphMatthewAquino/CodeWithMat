...
import PortfolioLogo from '/src/assets/codewithmat.png';

import ProfilePhoto from '/src/assets/grad-pic.jpg';

import PythonLogo from '/src/assets/python.svg';
import BootstrapLogo from '/src/assets/bootstrap.svg';
import JavaScriptLogo from '/src/assets/js.svg';
import JavaLogo from '/src/assets/java.svg';
import ReactLogo from '/src/assets/logo-react.svg';
import ViteLogo from '/src/assets/vite.svg';

import BantayKape from '/src/assets/bantaykape.png';
import BWRS from '/src/assets/droplet.svg';

import DMMMSUXCCS from '/src/assets/dmmmsuxccs.png';
import TESDA from '/src/assets/tesda.png';
import PCLU from '/src/assets/pclu.png';
...
const AboutMe = {
    ...
    social_links: [
        {
            platform: 'Facebook',
            url: 'https://www.facebook.com/akoaymatsu',
        ...
        {
            platform: 'LinkedIn',
            url: 'https://www.linkedin.com/in/ralph-matthew-r-aquino-624a1b320/',
            icon: <FaLinkedin 
                    size={iconProperties.size}
        ...
        {
            platform: 'GitHub',
            url: 'https://github.com/RalphMatthewAquino',
            icon: <FaGithubSquare 
                    size={iconProperties.size}
